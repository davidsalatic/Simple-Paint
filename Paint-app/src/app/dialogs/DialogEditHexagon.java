...
public class DialogEditHexagon extends JDialog {
	...
	public DialogEditHexagon(HexagonAdapter h)
	{
		...
		tfX.setText(String.valueOf(h.getX()));
		...
		tfY.setText(String.valueOf(h.getY()));
		...
		btnOutlineColor.setBackground(h.getOutlineColor());
		btnOutlineColor.addActionListener(new ActionListener() {
			@SuppressWarnings("static-access")
			public void actionPerformed(ActionEvent arg0) {
				JColorChooser jccOutline = new JColorChooser();
				chosenOutlineColor=jccOutline.showDialog(null, "Choose outline color", h.getOutlineColor());

				if(chosenOutlineColor==null)
					chosenOutlineColor=h.getOutlineColor();
		...
		btnInsideColor.setBackground(h.getInsideColor());
		btnInsideColor.addActionListener(new ActionListener() {
			@SuppressWarnings("static-access")
			public void actionPerformed(ActionEvent e) {
				JColorChooser jccInside = new JColorChooser();
				chosenInsideColor=jccInside.showDialog(null, "Choose inside color", h.getInsideColor());

				if(chosenInsideColor==null)
					chosenInsideColor=h.getInsideColor();
		...
		btnAccept.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				try {
					...
					JOptionPane.showMessageDialog(DialogEditHexagon.this, "Only numbers 1-890 for X, 1-460 for Y and 1-300 for Radius allowed!","Error",JOptionPane.ERROR_MESSAGE);
				}
			}
		});
